...
#Screen generation Varimport libtcodpy as libtcod
import math
import textwrap
import shelve
...
def place_objects(room):
    ...
    monster_chances['skeleton'] = from_dungeon_level([[20, 5], [40, 8], [70, 10]])
    ...
    for i in range(num_monsters):
        ...
        if not is_blocked(x, y):
            ...
            if choice == 'orc':
                ...
                #ahhhhhh!!!!!!!
                fighter_component = Fighter(hp = 100, defense = 4, power = 10, xp = 400, death_function = monster_death)
                ai_component = BasicMonster()
